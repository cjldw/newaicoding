...
export default function TestReport({ taskIdProp, embedded = false }: { taskIdProp?: string; embedded?: boolean } = {}) {
  // R4.F4:embedded=true 时被任务工作台中栏「测试报告」Tab 内嵌 —— 用传入 taskId、去掉页壳标题
    ...
    <div className={embedded ? '' : 'page wide'}>
      {!embedded && (
        <div className="page-head">
          ...
          <h1 className="flex items-center gap-2 text-2xl font-semibold text-text"><BarChart3 size={18} /> 测试报告</h1>
